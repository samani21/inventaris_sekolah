...
<br>
<div>
    <form action="<?= base_url($page . '/update/' . $dt['id']) ?>" method="post" enctype="multipart/form-data">
        <?php
        foreach ($form as $f) {
        ...
        ?>
                ...
                <input type="text" name="<?= $f['name'] ?>" value="<?= $dt[$f['name']] ?>" class="form-control" required autofocus>
            ...
            ?>
                ...
                <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                <select name="<?= $f['name'] ?>" id="" required class="form-control">
            ...
            ?>
                ...
                <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                <input type="email" name="<?= $f['name'] ?>" value="<?= $dt[$f['name']] ?>" class="form-control" required autofocus>
            ...
            ?>
                ...
                <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                <input type="password" name="<?= $f['name'] ?>" placeholder="Jika tidak ganti password kosongkan" class="form-control" autofocus>
            ...
            ?>
                ...
                <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                <input type="date" name="<?= $f['name'] ?>" value="<?= $dt[$f['name']] ?>" class="form-control" placeholder="Input <?= transformTableName($f['name']) ?>" required autofocus>
            ...
            <?php
                ...
                ?>
                    ...
                    <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                    <input type="number" name="<?= $f['name'] ?>" value="<?= $dt[$f['name']] ?>" class="form-control" placeholder="Input <?= transformTableName($f['name']) ?>" required autofocus>
            ...
            ?>
                ...
                <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                <input type="file" name="<?= $f['name'] ?>" class="form-control" placeholder="Input <?= transformTableName($f['name']) ?>" autofocus>
            ...
            <?php
                ...
                ?>
                    ...
                    <label for="<?= $f['name'] ?>" class="col-md-3 col-form-label"><?= transformTableName($f['name']) ?></label>
                    <textarea name="<?= $f['name'] ?>"  class="form-control" id=""><?= $dt[$f['name']] ?></textarea>
